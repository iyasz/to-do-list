...
<body class="">
    ...
    <div class="max-w-5xl mx-auto w-full">
        <div class="my-12 flex justify-center w-full">  
            <div class="md:w-[700px] w-[92%] min-h-[700px] rounded-lg bg-white border-2 md:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] shadow-none">
                ...
                <div class="p-5">
                    <div class="flex justify-center items-center md:gap-9 gap-5 mt-7">
                        ...
                        <div class="text-center md:w-[200px] w-full">
                    ...
                    <div class="mt-10">
                        <form method="POST" action="/activity" class="md:mx-10 mx-auto flex items-center h-full gap-3"> 
                            @csrf
                    ...
                    <div class="list mt-14 md:px-10 px-auto">
